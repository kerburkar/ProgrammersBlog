    ...
    public class CategoryManager:ICategoryService
    {
        ...
        public async Task<IResult> Add(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            await _unitOfWork.Categories.AddAsync(category)                      
                .ContinueWith(t=>_unitOfWork.SaveAsync()); //zincirleme olarak işlemesi için. 
            //await _unitOfWork.SaveAsync(); //veri tabanına kaydetmek için.
        ...
        {
            var category = await _unitOfWork.Categories.GetAsync(c => c.Id == categoryId,null);
            if (category!=null)
            {
